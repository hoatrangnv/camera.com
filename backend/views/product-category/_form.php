...
<div class="product-category-form">
    ...
    <div class="col-md-6">
        ...
        <?= $form->field($model, 'banner', ['template' => '{label}<div class="picturecut_image_container" ' . (!$model->isNewRecord ? 'style="background-image:url(' . $model->getBanner() . ')"' : '') . '></div>{input}{error}{hint}'])->textInput(['maxlength' => true, 'readonly' => true]) ?>
    ...
    <div class="col-md-6">
        ...
        <?= $form->field($model, 'parent_id')->dropDownList($this->context->parent_productCategories_idToName, ['prompt' => '']) ?>
