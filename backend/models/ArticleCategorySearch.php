...
class ArticleCategorySearch extends ArticleCategory
{
    ...
    {
        return [
            [['id', 'parent_id', 'status', 'is_hot', 'position', 'is_active'], 'integer'],
            [['name', 'slug', 'old_slugs', 'description', 'long_description', 'meta_title', 'meta_description', 'meta_keywords', 'h1', 'page_title', 'image', 'banner', 'image_path', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'safe'],
        ];
    }
