...
class TagSearch extends Tag
{
    ...
    {
        return [
            [['id', 'position', 'is_active', 'is_hot', 'status'], 'integer'],
            [['name', 'slug', 'old_slugs', 'page_title', 'h1', 'meta_title', 'meta_description', 'meta_keywords', 'description', 'long_description', 'image', 'image_path', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'safe'],
        ];
    }
