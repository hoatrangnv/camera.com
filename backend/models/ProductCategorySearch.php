...
class ProductCategorySearch extends ProductCategory
{
    ...
    {
        return [
            [['id', 'parent_id', 'is_hot', 'is_active', 'status', 'position'], 'integer'],
            [['slug', 'old_slugs', 'name', 'description', 'long_description', 'page_title', 'h1', 'meta_title', 'meta_description', 'meta_keywords', 'image', 'banner', 'image_path', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'safe'],
        ];
    }
